...
export default {
  ...
  setup() {
    ...
    const rules = {
      ...
      confirmedPassword: { required, sameAsPassword: sameAs(() => state.password) },
    };
    ...
    const register = async () => {
      ...
      console.log('Validation result:', valid);
      console.log('confirmedPassword sameAsPassword status:', v$.value.confirmedPassword.sameAsPassword.$invalid, v$.value.confirmedPassword.sameAsPassword.$params);
      if (!valid) {
    ...
    return {
      ...
      rawCountries,
      register,
      v$, // return the ref, template unwraps it
    };
  },
};
</script> -->
